...
public class Students {
    ...
    static class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            String response = "<html><head><title>Students List</title></head><body>" +
                    "<h2>Students List</h2>" +
    ...
    static class AddHandler implements HttpHandler {
        ...
        private String getAddForm() {
            String htmlFilePath = "src\\html\\Students.html";
            try {
    ...
    static class AddSubmitHandler implements HttpHandler {
        ...
        private void addDataToDatabase(String formData) {
            try {
                ...
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/university", "root", "");
                String insertQuery = "insert into students (name, surname, age, gender) values (?, ?, ?, ?)";
    ...
    private static String getDataFromDatabase() {
        ...
        try {
            ...
            result.append("<html><head>")
                    ...
                    .append("<h2><a href=\"http://localhost:8081\">Teachers</a></h2>")
    ...
    private static void updateDataInDatabase(String query) {
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/university", "root", "");
            String updateQuery = "update students set name=?, surname=?, age=?, gender=? where id=?";
