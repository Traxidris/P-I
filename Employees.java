...
public class Employees {
    ...
    static class MyHandler implements HttpHandler {
        ...
        public void handle(HttpExchange t) throws IOException {
            String response = "<html><head><title>Employees List</title></head><body>" +
    ...
    static class AddHandler implements HttpHandler {
        ...
        private String getAddForm() {
            String htmlFilePath = "src\\html\\Employees.html";
            try {
    ...
    static class AddSubmitHandler implements HttpHandler {
        ...
        private void addDataToDatabase(String formData) {
            try {
                ...
                Class.forName("com.mysql.cj.jdbc.Driver");
                Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/university", "root", "");
                String insertQuery = "insert into employees (name, surname, age, gender) values (?, ?, ?, ?)";
    ...
    private static String searchFromDatabase(String surname) {
        ...
        try {
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/university", "root", "");
            PreparedStatement preparedStatement = connection.prepareStatement("SELECT * FROM employees WHERE surname LIKE ?");
    ...
    private static String getDataFromDatabase() {
        ...
        try {
            ...
            result.append("<html><head>")
                    ...
                    .append("<h2><a href=\"http://localhost:8080\">Students</a></h2>") // Κουμπί Teachers
                    .append("<h2><a href=\"http://localhost:8081\">Teachers</a></h2>") // Κουμπί Employees
                    .append("<table><tr><th>ID</th><th>Name</th><th>Surname</th><th>Age</th><th>Gender</th><th>Actions</th></tr>");
            while (resultSet.next()) {
                result.append("<tr>")
                        .append("<td>").append(resultSet.getInt("id")).append("</td>")
    ...
    private static void updateDataInDatabase(String query) {
        try {
            ...
            Class.forName("com.mysql.cj.jdbc.Driver");
            Connection connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/university", "root", "");
            String updateQuery = "update employees set name=?, surname=?, age=?, gender=? where id=?";
